...
const itemWrapper = `bg-white shadow-inset hover:shadow-none flex justify-between items-center pl-5 gap-5 mx-auto w-full xl:w-1/2 transition-transform ease-linear duration-75 transform sm:hover:scale-105 sm:hover:bg-orange sm:hover:text-white`
